      ...
      {deleteTarget && (
        ...
        >
          <div className="modal-content" onClick={e => e.stopPropagation()} role="dialog" aria-modal="true" aria-labelledby="player-delete-title">
            <h2 id="player-delete-title" className="text-2xl font-bold text-red-500 mb-4 text-center">{t('admin.players.deletePlayer')}</h2>
            <p className="text-lg mb-6 text-center">{t('admin.players.deleteConfirmMessage', { name: deleteTarget.name })}</p>
            <div className="flex gap-4">
